...
- [x] **Rechtstexte umgesetzt:** Impressum, Datenschutzerklärung, AGB und
      Widerrufsbelehrung einschließlich Muster-Widerrufsformular sind unter
      `apps/web/app/pages/legal/{imprint,privacy,terms,withdrawal}.vue` mit den
      Angaben von Robert Schreiner hinterlegt und im Footer verlinkt.
- [ ] **Rechtstexte prüfen lassen:** Vor Livegang müssen insbesondere
      Widerrufs-Ausschlüsse, Vertragsablauf und die Datenschutzerklärung durch
      Rechtsberatung geprüft und freigegeben werden.
- [x] **Upload-Bedingungen**: verpflichtende Zustimmung mit Fassung
      `2026-07-13` ist in Frontend, API und Datenbank umgesetzt. Jede spätere
      inhaltliche Änderung benötigt eine neue Versionskennung und Rechtsprüfung.
- [x] **Löschkonzept / Aufbewahrungsfristen**: festgelegt in
      `docs/deletion-retention.md` (Rechnungen: 10 Jahre). Vor dem ersten
      automatisierten Löschlauf sind Löschsperren und der Wartungsjob umzusetzen.
